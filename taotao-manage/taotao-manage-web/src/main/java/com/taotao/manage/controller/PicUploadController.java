...
public class PicUploadController {
	...
	public String upload(@RequestParam("uploadFile") MultipartFile uploadFile, HttpServletResponse response) throws Exception {
		...
		// 生成图片的绝对引用地址
		String picUrl = StringUtils.replace(StringUtils.
				substringAfter(filePath, propertieService.REPOSITORY_PATH), "\\", "/");
	...
	/**
	 * 在淘淘商城\taotao-upload目录下会创建images文件夹，按照 年-月-日 做一个区分的存储。
