...
public class  ItemController {
	...
	public ResponseEntity<Void> saveItem(Item item, @RequestParam("desc") String desc, @RequestParam("itemParams") String itemParams){
		try {
			...
			if(StringUtils.isEmpty(item.getTitle())){   //TODO 未完成
				//参数有误 400
	...
	public ResponseEntity<Void> deleteItem(@RequestParam(value = "params[]") List<Object> params) {
		try {
			//删除商品
			Integer integer = this.itemService.deleteByIds(params,Item.class,"params");
